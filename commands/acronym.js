...
const getAcronym = (payload, acronym) => {
  if(acronym) {
    ...
    if(!found) {
      let text = "The acronym you requested (*" + acronym + "*) was not found.  Add it to the <https://docs.google.com/spreadsheets/d/13fcfWufGFEIVvca-1hP7mchVg9q6n7LOvdxYDBTdQiw|acronyms sheet> and then issue the `refresh acronyms` command";
      slackServices.postMessage(payload, text);
    } 
  } else {
